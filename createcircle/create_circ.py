...
class CreateCircle:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CreateCircle_{}.qm'.format(locale))
        ...
        self.dlg = CreateCircleDialog()

        self.dlg.pushButtonAddCircle.clicked.connect(self.add_circle)

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&CreateCircle')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'CreateCircle')
        self.toolbar.setObjectName(u'CreateCircle')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CreateCircle', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/create_circ/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'CreateCircle'),
            callback=self.run,
